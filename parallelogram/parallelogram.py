...
def write_area_products( self, n1, n2, ar ):
    p = n1 * n2
    an1 = abs( n1 )
    an2 = abs( n2 )
...
class ScalarMultiplicationSign( Scene ):
    def construct( self ):
        ...
        self.wait( )
        g = write_area_products( self, 2, 3, 0.1 )
        self.play( FadeOut( g ) )
        g = write_area_products( self, 3, 2, 0.1 )
        self.play( FadeOut( g ) )
        g = write_area_products( self, 1, 1, 0.2 )

        o = np.array( 1 * (RIGHT + UP) )
        v1 = np.array( [ 1, 0, 0 ] )
        v2 = np.array( [ 0, 1, 0 ] )
        pts = [ o, o + v1, o + v1 + v2, o + v2 ]
        rect1 = OrientedPolygon2( *pts, c0 = GREEN_B, c1 = RED, c2 = BLUE, f = 0.5, s1 = 1, s2 = 1, r = 0.2 )
        ...
        v2 = np.array( [ 0, 1, 0 ] )
        pts = [ o, o + v1, o + v1 + v2, o + v2 ]
        rect2 = OrientedPolygon2( *pts, c0 = GREEN_B, c1 = RED, c2 = BLUE, f = 0.5, s1 = -1, s2 = 1, r = 0.2 )
