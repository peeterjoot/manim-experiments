    ...
    def construct(self):
        ...
        eq = MathTex( concat( r'&{', l.text('Proj'), r'}_{\vec{u}}(\vec{v}) \cdot {', l.text('Rej'), r'}_{\vec{u}}(\vec{v})', l.nextline ),
                      concat( r'\quad&=', l.gpgradezero(
                          l.underbrace( l.lr( l.wedge(vecv, uhat) ), uhat, helptext=l.text('Rej') ),
                          l.underbrace( uhat, l.lr( l.dot(vecv, uhat) ), helptext=l.text('Proj') ) ),
                          l.nextline ),
                      concat( r'\quad &=', l.gpgradezero( l.wedge(vecv, uhat) ), l.lr( l.dot(vecv, uhat) ), l.nextline ),
