...
class m030_surfaceintegral( Scene ):
    def construct( self ):
        ...
        title2 = Text( "Surface integrals: examples." )
        ...
        eq2 = [ cMathTex( r"{{ \mathbf{x} }}(a, b) = a \mathbf{e}_1 + b \mathbf{e}_2" ),
                cMathTex( r"{{ \mathbf{x} }}_1 = \mathbf{e}_1, \quad {{ \mathbf{x} }}_2 = \mathbf{e}_2" ),
                cMathTex( r"d^2 {{ \mathbf{x} }} = \mathbf{e}_{12} da db, \quad F = \mathbf{e}_1, \quad G = \mathbf{e}_1 + \mathbf{e}_2" ),
                cMathTex( r"\int_{a = 0}^A \int_{b = 0}^{B} F d^2 x G =" ),
                cMathTex( r"\int_{a = 0}^A \int_{b = 0}^{B} \mathbf{e}_1 \mathbf{e}_{12} da db (\mathbf{e}_1 + \mathbf{e}_2)" ),
                cMathTex( r"A B \mathbf{e}_{2} (\mathbf{e}_1 + \mathbf{e}_2)" ),
                cMathTex( r"A B (1 - \mathbf{e}_{12})" ) ]
        ...
        eq2[4].move_to( eq2[3] ).shift( 5.30 * RIGHT )
        ...
        eq3 = [ cMathTex( r"{{ \mathbf{x} }}(r,\phi) = r \mathbf{e}_1 e^{i\phi}, \quad i = \mathbf{e}_{12}" ),
        ...
        eq3[4].move_to( eq3[3] ).shift( 5.60 * RIGHT )
        ...
        for i in range(5, 7):
            ...
            self.wait( 1 )
        #self.play( FadeOut( VGroup( eq3[0], eq3[1], eq3[2], eq3[3], eq3[6] ) ) )
