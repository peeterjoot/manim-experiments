...
class m40_dp( Scene ):
    def construct( self ):
        ...
        eq2 = [ MathTex( concat( l.frac( r'\partial \mathbf{x}', r'\partial \phi'), ' = r', vec_e3, l.frac( r'\partial ', r'\partial \phi'), l.lr( r'\cos\theta + j \sin\theta' ) ) ),
                MathTex( concat( ' = r', vec_e3, r'\sin\theta', l.frac( r'\partial j', r'\partial \phi') ) ),
                MathTex( concat( ' = r', vec_e3, r'\sin\theta', vec_e3, vec_e1, r'i e^{i\phi}' ) ),
                MathTex( concat( ' = r', r'\sin\theta', vec_e1, vec_e1, vec_e2, r'e^{i\phi}' ) ),
                MathTex( concat( ' = r', r'\sin\theta', vec_e2, r'e^{i\phi}' ) ) ]
        ...
        eq2p = [ MathTex( concat( l.frac( r'\partial \mathbf{x}', r'\partial \phi'), ' = r', r'\sin\theta', vec_e2, r'e^{i\phi}' ) ) ]
